...
const products = [
    ...
    new Product({
        ...
        price: 8.0,
        description:
            "Velit ut tortor pretium viverra suspendisse potenti nullam ac. Vitae sapien pellentesque habitant morbi tristique senectus et netus et. Proin sagittis nisl rhoncus mattis rhoncus. Suspendisse interdum consectetur libero id faucibus nisl tincidunt eget nullam. Ornare aenean euismod elementum nisi quis eleifend quam adipiscing vitae.",
    ...
    new Product({
        ...
        price: 20.0,
        description:
            "Id aliquet lectus proin nibh nisl condimentum id venenatis a. Egestas erat imperdiet sed euismod. Aliquet risus feugiat in ante metus dictum. Diam volutpat commodo sed egestas egestas. Vel facilisis volutpat est velit egestas dui id. Amet aliquam id diam maecenas ultricies mi eget mauris. ",
    ...
    new Product({
        ...
        price: 5.0,
        description:
            "Sem fringilla ut morbi tincidunt augue interdum velit euismod. Dui vivamus arcu felis bibendum. Eu lobortis elementum nibh tellus molestie nunc non blandit massa. Porta lorem mollis aliquam ut porttitor leo a diam sollicitudin. Dui sapien eget mi proin sed libero enim sed faucibus.",
